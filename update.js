 ...
 */
const stats = require('./data/general/2018-07-16-stats.json');
const comparisonStats = require('./data/general/2018-06-18-stats.json');
const GITHUB_PULL_REQUESTS_SINCE_DATE = '2018-06-01';
